...
{
    /// <summary>
    /// Реализация фрактала с одной аксивомой, несколькими правилами, углом поворота.
    /// Фрактал может принимать команды для рисования линии, перехода в точку без рисования линии, поворота на заданный угол по/против часовой стрелки, сохранением и восстановлением позиции.
    ...
    public class Fractal : IFractal
    {
        ...
        public Fractal(string axiom, string rule, int angle) :
        ...
        /// <param name="angle">Угол поворота в градусах.</param>
        public Fractal(string axiom, IEnumerable<string> rules, int angle)
        {
            Axiom = axiom;
        ...
        public Fractal(string axiom, IEnumerable<string> rules, int angle, IEnumerable<char> forwardLiterals) :
